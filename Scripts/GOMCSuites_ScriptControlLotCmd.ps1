...
ODBCConnection -dsn "CM_POS;Uid=omc;Pwd=omc" -query "select xchglot_id as ID, xchglot_chrono as DateCmd, xchglot_message as MessageErreur from xchg_lot where xchglot_statut = 4"
